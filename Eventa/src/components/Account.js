...
import '../styles/Account.css'; // Ensure you have this CSS file
      ...
      <div className='account'>
        <div className='Account-heading'>
          {user ? (
            ...
            <>
              <h1 className='welcome-text'>Welcome Guest to Fairy Lights</h1>
              <p id='query-text'>
                Would you like to&nbsp;
                <Link to='/signup' className='blue-link'>Signup</Link>&nbsp;
                or&nbsp;
